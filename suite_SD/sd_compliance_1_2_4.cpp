...
class SDCompliance_1_2_4Test : public SDCardTest
{
  private:

  public:
    SDCompliance_1_2_4Test(const TServerTestFactory &Factory) : SDCardTest(Factory)
    {
    }

    ~SDCompliance_1_2_4Test()
    {
    }
...
TServerTestInstance(SDCompliance_1_2_4Test, SDCompliance_1_2_4Test);
