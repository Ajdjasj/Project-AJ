...
class SDSwitchFuntionTest : public SDCardTest
{
  private:

  public:
    SDSwitchFuntionTest(const TServerTestFactory &Factory) : SDCardTest(Factory)
    {
    }
...
TServerTestInstance(SDSwitchFuntionTest, SDSwitchFuntionTest);
